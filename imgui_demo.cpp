...
static void ShowDemoWindowWidgets(ImGuiDemoWindowData* demo_data)
{
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            if (i > 0)
            {
                int frame_padding = (int)(float)(i * style.PointSize) - 1.0f;
    ...
    if (ImGui::TreeNode("Querying Window Status (Focused/Hovered etc.)"))
    {
        ...
        ImGui::BeginChild("child", ImVec2(0, 50.f * style.PointSize), ImGuiChildFlags_Border);
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Child windows"))
    {
        ...
        // Child 1: no border, enable horizontal scrollbar
        {
            ...
            ImGui::BeginChild("ChildL", ImVec2(ImGui::GetContentRegionAvail().x * 0.5f, 260.f * style.PointSize), ImGuiChildFlags_None, window_flags);
            for (int i = 0; i < 100; i++)
        ...
        // Child 2: rounded border
        {
            ...
            ImGui::BeginChild("ChildR", ImVec2(0, 260.f * style.PointSize), ImGuiChildFlags_Border, window_flags);
        ...
        //   the POV of the parent window). See 'Demo->Querying Status (Edited/Active/Hovered etc.)' for details.
        {
            ...
            ImGui::BeginChild("Red", ImVec2(200.f * style.PointSize, 100.f * style.PointSize), child_flags, ImGuiWindowFlags_None);
            if (override_bg_color)
                ImGui::PopStyleColor();
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            const bool child_is_visible = ImGui::BeginChild(child_id, ImVec2(child_w, 200.0f * style.PointSize), ImGuiChildFlags_Border, child_flags);
            if (ImGui::BeginMenuBar())
            {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            bool child_is_visible = ImGui::BeginChild(child_id, ImVec2(-100.f * style.PointSize, child_height), ImGuiChildFlags_Border, child_flags);
            if (scroll_to_off)
...
static void ShowExampleAppLayout(bool* p_open)
{
    ...
    if (ImGui::Begin("Example: Simple layout", p_open, ImGuiWindowFlags_MenuBar))
    {
        ...
        {
            ImGui::BeginChild("left pane", ImVec2(150.f * style.PointSize, 0), ImGuiChildFlags_Border | ImGuiChildFlags_ResizeX);
            for (int i = 0; i < 100; i++)
            {
...
static void ShowExampleAppConstrainedResize(bool* p_open)
{
    ...
    if (type == 0) ImGui::SetNextWindowSizeConstraints(ImVec2(100.f * style.PointSize, 100.f * style.PointSize), ImVec2(500.f * style.PointSize, 500.f * style.PointSize));         // Between 100x100 and 500x500
    if (type == 1) ImGui::SetNextWindowSizeConstraints(ImVec2(100.f * style.PointSize, 100.f * style.PointSize), ImVec2(FLT_MAX, FLT_MAX)); // Width > 100, Height > 100
    ...
    if (type == 4) ImGui::SetNextWindowSizeConstraints(ImVec2(400.f * style.PointSize, -1),  ImVec2(500.f * style.PointSize, -1));          // Width Between and 400 and 500
    if (type == 5) ImGui::SetNextWindowSizeConstraints(ImVec2(-1, 400.f * style.PointSize),  ImVec2(-1, FLT_MAX));      // Height at least 400
    ...
    if (window_open)
    {
        ...
        else
        {
            ...
            if (ImGui::Button("Set 200x200")) { ImGui::SetWindowSize(ImVec2(200.f * style.PointSize, 200.f * style.PointSize)); } ImGui::SameLine();
            if (ImGui::Button("Set 500x500")) { ImGui::SetWindowSize(ImVec2(500.f * style.PointSize, 500.f * style.PointSize)); } ImGui::SameLine();
            if (ImGui::Button("Set 800x200")) { ImGui::SetWindowSize(ImVec2(800.f * style.PointSize, 200.f * style.PointSize)); }
